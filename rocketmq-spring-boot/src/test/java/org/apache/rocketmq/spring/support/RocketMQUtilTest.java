...
public class RocketMQUtilTest {
    ...
    public void testConvertToSpringMessage() {
        ...
        assertEquals("test", message.getHeaders().get(RocketMQUtil.toRocketHeaderKey(RocketMQHeaders.TOPIC)));
        assertEquals("tagA", message.getHeaders().get(RocketMQUtil.toRocketHeaderKey(RocketMQHeaders.TAGS)));
        assertEquals("key1", message.getHeaders().get(RocketMQUtil.toRocketHeaderKey(RocketMQHeaders.KEYS)));
    }
